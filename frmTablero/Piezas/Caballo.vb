Public Class Caballo
    ...
    'Método que comprueba si la posición final del caballo es una de las posibles que puede hacer,
    'esté devuelve 1 en caso de no poder o de estar ocupada por una pieza del mismo color
